...
// A FUNCTION TO EXPORT THE ALLCOLLECTIONSPAGEMODAL BY DEFAULT
export default function AllCollectionsPageModal(props) {
  // DEFINING VARIABLES
  ...
  return (
    <div className="modal-contentt fixed top-0 right-0 w-full h-full bg-black items-center bg-opacity-100 z-50 animate-modal">
      <span className="close-button absolute top-5 left-5 text-3xl cursor-pointer text-gray-200 hover:text-gray-600" onClick={closeModal}>&times;</span>
      ...
      <div className="content flex items-center m-5 my-2 justify-between border-b border-slate-400 p-6   ">
        ...
        <div>
          <span className="selected  text-sm">All Time Volume</span>

          <span>
            <NavigateNextIcon className="next-icon text-gray-600 text-lg" />
          </span>
        </div>
      </div>
      ...
      <div className="content flex items-center m-5 my-2 justify-between border-b border-slate-400 p-6  ">
        ...
        <div>
          <span className="selected  text-sm">Verified Only</span>
      ...
      <div className="content flex items-center m-2 my-2 justify-between border-b border-slate-400 p-6  ">
        ...
        <div>
          <span className="selected  text-sm">All</span>

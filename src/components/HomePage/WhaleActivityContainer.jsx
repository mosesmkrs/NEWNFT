            ...
            {[
              ...
              return (
                <button
                  ...
                  className={"border-none w-[10px] h-[10px] rounded-[50%] my-0 mx-[5px] p-[5px] cursor-pointer focus:outline-none active:bg-black" + (currentSlide === idx ? " bg-black" : " bg-blue-500")}
                ></button>
              )
            })}
          </div>

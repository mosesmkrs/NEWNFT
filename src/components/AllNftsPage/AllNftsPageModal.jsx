...
// EXPORTING A FUNCTION THAT RETURNS THE ALLNFTSPAGE MODAL
export default function AllNftsPageModal(props){
  // DECLARING VARIABLES
  const {closeModal} = props
  // A STATE TO KEEP TRACK OF SELECTED OPTION
  const [selectedOption, setSelectedOption] = useState(null);

  // A FUNCTION TO SET SELECTED OPTION
  ...
  return (
    <div className="modal-contentt fixed top-0 right-0 w-full h-full  items-center bg-opacity-100 z-50 animate-modal">
      ...
      <div className="content flex items-center m-5 my-2 justify-between border-b border-slate-400 p-6   ">
        ...
        <div>
          <span className="selected  text-sm">Selected</span>
      ...
      <div className="content flex items-center m-5 my-2 justify-between border-b border-slate-400 p-6  ">
        ...
        <div>
          <span className="selected  text-sm">Recently Listed</span>
      ...
      <div className="content flex items-center m-5 my-2 justify-between border-b border-slate-400 p-6   ">
        ...
        <div>
          <span className="selected  text-sm">All Prices</span>
